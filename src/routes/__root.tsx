...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ConcretLab — Dosagem e Custeio de Concreto" },
      { name: "description", content: "Plataforma técnica para fabricantes de artefatos de concreto: dosagem, custeio e controle de qualidade." },
    ],
